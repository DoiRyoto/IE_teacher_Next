...
export default function GridPapers(params: {user: User | null, papers: paperData[], onClickLikeButton: Function}) {
            ...
            list.push(
                ...
                <Card className={colorCitationCount(paper.citationCount)}>
                    ...
                    <Stack divider={<StackDivider />} spacing="4">
                        ...
                        {params.user && (
                            <Box>
                            <IconButton aria-label='like' icon={<FiStar />} onClick={() => params.onClickLikeButton(paper)} bg={"white"} color={paper.isLike ?  "red": "black"}/>
                            </Box>
                        )
                        }
                        </Stack>
